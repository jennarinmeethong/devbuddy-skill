...
Every dispatch includes `memory_root`, `task_id`, `task_path`, `read_keys`, `read_paths`, `write_scope`, `handoff_path`, `parent_revision`, reservation, and redaction requirements. The next slice receives only the relevant handoff delta.

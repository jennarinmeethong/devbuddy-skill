#!/usr/bin/env python3
"""Validate required self-contained Codex manual pages."""
from __future__ import annotations

import argparse
from pathlib import Path

PAGES = ["index.html", "en/index.html", "th/index.html", "en/codex.html", "th/codex.html", "assets/style.css"]
...
def main() -> int:
    ...
    if errors:
        for error in errors:
            print(f"ERROR: {error}")
        return 1
    print(f"OK: Codex manual conformance passed for {args.manual_root}")
    return 0

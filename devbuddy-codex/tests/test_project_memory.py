...
class TaskMemoryTests(unittest.TestCase):
    ...
    def test_json_slice_record_persists_for_the_next_slice(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            payload = {"schema_version": 1, "task_id": "001", "slice_id": "developer", "attempt": 1, "parent_revision": 0, "role": "developer", "model": "model-basic", "effort": "low", "status": "completed", "result": "Implemented focused change.", "evidence": [], "next_slice": {"summary": "Run focused tests.", "read_paths": [], "read_keys": []}, "knowledge_keys": [], "knowledge_proposal": None, "blockers": [], "required_approval": None}
...
class InstallerTests(unittest.TestCase):
    ...
    def test_installed_payload_excludes_development_files(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:

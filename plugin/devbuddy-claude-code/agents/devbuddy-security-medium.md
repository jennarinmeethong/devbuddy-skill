...
description: DevBuddy Security (medium effort) — threat modelling, findings, and remediation verification. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: red
---

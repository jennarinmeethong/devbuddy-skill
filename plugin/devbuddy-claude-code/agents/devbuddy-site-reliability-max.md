---
name: devbuddy-site-reliability-max
description: DevBuddy Site Reliability (max effort) — SLOs, observability, and incident coordination. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: cyan
---

# DevBuddy Site Reliability (max effort)

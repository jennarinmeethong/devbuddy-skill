...
description: DevBuddy QA (ultracode effort) — independent testing, defects, and quality evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: green
---
...
2. Define risk-based test strategy and requirement-to-test traceability.

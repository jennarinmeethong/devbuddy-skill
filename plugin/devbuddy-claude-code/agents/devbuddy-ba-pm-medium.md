...
description: DevBuddy BA/PM (medium effort) — business analysis, scope, acceptance criteria, and priority. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: purple
---

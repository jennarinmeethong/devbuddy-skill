---
name: devbuddy-model-evaluator-high
description: DevBuddy Model Evaluator (high effort) — AI model evaluation, safety, and performance evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: yellow
---

# DevBuddy Model Evaluator (high effort)

---
name: devbuddy-backend-engineer-high
description: DevBuddy Backend Engineer (high effort) — service implementation, contracts, and integration evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: blue
---

# DevBuddy Backend Engineer (high effort)

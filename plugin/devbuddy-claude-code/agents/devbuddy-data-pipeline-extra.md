---
name: devbuddy-data-pipeline-extra
description: DevBuddy Data Pipeline Engineer (extra effort) — ETL/ELT, data quality, lineage, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: yellow
---

# DevBuddy Data Pipeline Engineer (extra effort)

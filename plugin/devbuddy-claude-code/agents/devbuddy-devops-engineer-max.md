---
name: devbuddy-devops-engineer-max
description: DevBuddy DevOps Engineer (max effort) — CI/CD, delivery automation, and deployment evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: cyan
---

# DevBuddy DevOps Engineer (max effort)

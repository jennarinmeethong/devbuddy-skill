---
name: devbuddy-code-reviewer-medium
description: DevBuddy Code Reviewer (medium effort) — independent code-level findings and review evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: purple
---

# DevBuddy Code Reviewer (medium effort)

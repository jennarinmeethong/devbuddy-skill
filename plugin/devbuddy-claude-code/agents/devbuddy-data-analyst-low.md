---
name: devbuddy-data-analyst-low
description: DevBuddy Data Analyst (low effort) — reproducible analysis, metrics, and insight limits. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: yellow
---

# DevBuddy Data Analyst (low effort)

---
name: devbuddy-model-evaluator-max
description: DevBuddy Model Evaluator (max effort) — AI model evaluation, safety, and performance evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: yellow
---

# DevBuddy Model Evaluator (max effort)

---
name: devbuddy-cloud-infrastructure-ultracode
description: DevBuddy Cloud Infrastructure (ultracode effort) — infrastructure as code, resilience, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: cyan
---

# DevBuddy Cloud Infrastructure (ultracode effort)

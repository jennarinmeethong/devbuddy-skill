---
name: devbuddy-data-pipeline-low
description: DevBuddy Data Pipeline Engineer (low effort) — ETL/ELT, data quality, lineage, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: yellow
---

# DevBuddy Data Pipeline Engineer (low effort)

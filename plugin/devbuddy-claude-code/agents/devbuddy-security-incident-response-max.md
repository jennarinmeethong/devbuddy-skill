---
name: devbuddy-security-incident-response-max
description: DevBuddy Security Incident Response (max effort) — incident coordination, containment, recovery, and evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: red
---

# DevBuddy Security Incident Response (max effort)

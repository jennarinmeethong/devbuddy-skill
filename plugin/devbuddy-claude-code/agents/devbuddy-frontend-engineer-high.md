---
name: devbuddy-frontend-engineer-high
description: DevBuddy Frontend Engineer (high effort) — client implementation, accessibility, and UI evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: blue
---

# DevBuddy Frontend Engineer (high effort)

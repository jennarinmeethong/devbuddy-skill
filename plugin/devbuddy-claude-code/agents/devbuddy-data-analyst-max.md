---
name: devbuddy-data-analyst-max
description: DevBuddy Data Analyst (max effort) — reproducible analysis, metrics, and insight limits. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: yellow
---

# DevBuddy Data Analyst (max effort)

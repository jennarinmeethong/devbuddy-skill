---
name: devbuddy-reviewer-extra
description: DevBuddy Reviewer (extra effort) — independent review findings on an assigned artefact. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: purple
---

# DevBuddy Reviewer (extra effort)

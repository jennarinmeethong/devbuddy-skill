---
name: devbuddy-knowledge-base-high
description: DevBuddy Knowledge Base (high effort) — verified documentation, FAQs, and content health. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: purple
---

# DevBuddy Knowledge Base (high effort)

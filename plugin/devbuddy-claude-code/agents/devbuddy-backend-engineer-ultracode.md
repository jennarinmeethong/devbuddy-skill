---
name: devbuddy-backend-engineer-ultracode
description: DevBuddy Backend Engineer (ultracode effort) — service implementation, contracts, and integration evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: blue
---

# DevBuddy Backend Engineer (ultracode effort)

---
name: devbuddy-backend-engineer-medium
description: DevBuddy Backend Engineer (medium effort) — service implementation, contracts, and integration evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: blue
---

# DevBuddy Backend Engineer (medium effort)

---
name: devbuddy-helpdesk-support-max
description: DevBuddy Helpdesk Support (max effort) — first-line diagnosis, guidance, and escalation. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: green
---

# DevBuddy Helpdesk Support (max effort)

---
name: devbuddy-ux-ui-high
description: DevBuddy UX/UI (high effort) — user journeys, screens, states, and accessibility. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: pink
---

# DevBuddy UX/UI (high effort)

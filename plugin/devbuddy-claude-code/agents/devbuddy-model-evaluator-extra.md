---
name: devbuddy-model-evaluator-extra
description: DevBuddy Model Evaluator (extra effort) — AI model evaluation, safety, and performance evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: yellow
---

# DevBuddy Model Evaluator (extra effort)

---
name: devbuddy-knowledge-base-low
description: DevBuddy Knowledge Base (low effort) — verified documentation, FAQs, and content health. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: purple
---

# DevBuddy Knowledge Base (low effort)

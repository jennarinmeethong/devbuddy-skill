---
name: devbuddy-security-incident-response-ultracode
description: DevBuddy Security Incident Response (ultracode effort) — incident coordination, containment, recovery, and evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: red
---

# DevBuddy Security Incident Response (ultracode effort)

---
name: devbuddy-compliance-policy-low
description: DevBuddy Compliance & Policy (low effort) — control mapping, policy conformance, and audit evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: red
---

# DevBuddy Compliance & Policy (low effort)

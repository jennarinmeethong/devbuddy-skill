...
description: DevBuddy Security (ultracode effort) — threat modelling, findings, and remediation verification. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: red
---

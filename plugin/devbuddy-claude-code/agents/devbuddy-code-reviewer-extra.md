---
name: devbuddy-code-reviewer-extra
description: DevBuddy Code Reviewer (extra effort) — independent code-level findings and review evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: purple
---

# DevBuddy Code Reviewer (extra effort)

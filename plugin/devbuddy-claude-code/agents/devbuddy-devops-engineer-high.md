---
name: devbuddy-devops-engineer-high
description: DevBuddy DevOps Engineer (high effort) — CI/CD, delivery automation, and deployment evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: cyan
---

# DevBuddy DevOps Engineer (high effort)

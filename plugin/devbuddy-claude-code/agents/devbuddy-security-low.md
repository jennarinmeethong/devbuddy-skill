...
description: DevBuddy Security (low effort) — threat modelling, findings, and remediation verification. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: red
---

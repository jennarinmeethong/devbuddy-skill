---
name: devbuddy-requirements-analyst-high
description: DevBuddy Requirements Analyst (high effort) — requirements, user stories, acceptance criteria, and traceability. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: purple
---

# DevBuddy Requirements Analyst (high effort)

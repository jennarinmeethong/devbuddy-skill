---
name: devbuddy-cloud-infrastructure-medium
description: DevBuddy Cloud Infrastructure (medium effort) — infrastructure as code, resilience, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: cyan
---

# DevBuddy Cloud Infrastructure (medium effort)

---
name: devbuddy-requirements-analyst-medium
description: DevBuddy Requirements Analyst (medium effort) — requirements, user stories, acceptance criteria, and traceability. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: purple
---

# DevBuddy Requirements Analyst (medium effort)

---
name: devbuddy-requirements-analyst-extra
description: DevBuddy Requirements Analyst (extra effort) — requirements, user stories, acceptance criteria, and traceability. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: purple
---

# DevBuddy Requirements Analyst (extra effort)

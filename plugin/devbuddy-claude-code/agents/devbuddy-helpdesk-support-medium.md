---
name: devbuddy-helpdesk-support-medium
description: DevBuddy Helpdesk Support (medium effort) — first-line diagnosis, guidance, and escalation. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: green
---

# DevBuddy Helpdesk Support (medium effort)

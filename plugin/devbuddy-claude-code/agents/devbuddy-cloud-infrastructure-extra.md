---
name: devbuddy-cloud-infrastructure-extra
description: DevBuddy Cloud Infrastructure (extra effort) — infrastructure as code, resilience, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: cyan
---

# DevBuddy Cloud Infrastructure (extra effort)

---
name: devbuddy-code-reviewer-ultracode
description: DevBuddy Code Reviewer (ultracode effort) — independent code-level findings and review evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: purple
---

# DevBuddy Code Reviewer (ultracode effort)

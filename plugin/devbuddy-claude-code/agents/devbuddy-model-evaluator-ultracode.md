---
name: devbuddy-model-evaluator-ultracode
description: DevBuddy Model Evaluator (ultracode effort) — AI model evaluation, safety, and performance evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: yellow
---

# DevBuddy Model Evaluator (ultracode effort)

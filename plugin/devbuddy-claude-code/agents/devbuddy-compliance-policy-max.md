---
name: devbuddy-compliance-policy-max
description: DevBuddy Compliance & Policy (max effort) — control mapping, policy conformance, and audit evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: red
---

# DevBuddy Compliance & Policy (max effort)

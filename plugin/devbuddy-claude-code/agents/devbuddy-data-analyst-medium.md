---
name: devbuddy-data-analyst-medium
description: DevBuddy Data Analyst (medium effort) — reproducible analysis, metrics, and insight limits. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: yellow
---

# DevBuddy Data Analyst (medium effort)

---
name: devbuddy-devops-engineer-ultracode
description: DevBuddy DevOps Engineer (ultracode effort) — CI/CD, delivery automation, and deployment evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: cyan
---

# DevBuddy DevOps Engineer (ultracode effort)

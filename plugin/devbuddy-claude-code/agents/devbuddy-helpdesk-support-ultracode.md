---
name: devbuddy-helpdesk-support-ultracode
description: DevBuddy Helpdesk Support (ultracode effort) — first-line diagnosis, guidance, and escalation. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: green
---

# DevBuddy Helpdesk Support (ultracode effort)

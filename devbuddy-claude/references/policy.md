...
- Never guess. When a fact, requirement, intent, constraint, permission, risk, or expected outcome is uncertain, stop only the affected branch and return a blocked handoff stating the unknown, why it matters, what was checked, and the question needed to proceed.

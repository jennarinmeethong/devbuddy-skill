...
1. Create or resume the ledger with task memory, resolve validated settings and the memory root, and act as the sole writer for ledger/canonical-memory updates after approval.

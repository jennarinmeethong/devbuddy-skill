---
name: devbuddy-requirements-analyst-max
description: DevBuddy Requirements Analyst (max effort) — requirements, user stories, acceptance criteria, and traceability. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: purple
---

# DevBuddy Requirements Analyst (max effort)

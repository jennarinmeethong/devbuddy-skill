...
description: DevBuddy Reviewer specialist at extra reasoning effort, covering independent review findings on an assigned artefact. Dispatched only by the DevBuddy Orchestrator through /devbuddy with an explicit model; do not select it for ordinary requests.
effort: extra
color: purple
---

---
name: devbuddy-security-low
description: DevBuddy Security specialist at low reasoning effort, covering threat modelling, findings, and remediation verification. Dispatched only by the DevBuddy Orchestrator through /devbuddy with an explicit model; do not select it for ordinary requests.
effort: low
color: red
---

# DevBuddy Security (low effort)

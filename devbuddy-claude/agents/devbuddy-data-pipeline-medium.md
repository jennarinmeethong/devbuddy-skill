---
name: devbuddy-data-pipeline-medium
description: DevBuddy Data Pipeline Engineer (medium effort) — ETL/ELT, data quality, lineage, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: yellow
---

# DevBuddy Data Pipeline Engineer (medium effort)

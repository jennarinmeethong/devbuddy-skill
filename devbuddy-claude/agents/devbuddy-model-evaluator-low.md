---
name: devbuddy-model-evaluator-low
description: DevBuddy Model Evaluator (low effort) — AI model evaluation, safety, and performance evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: yellow
---

# DevBuddy Model Evaluator (low effort)

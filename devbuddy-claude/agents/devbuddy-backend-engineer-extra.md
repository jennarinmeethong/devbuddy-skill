---
name: devbuddy-backend-engineer-extra
description: DevBuddy Backend Engineer (extra effort) — service implementation, contracts, and integration evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: blue
---

# DevBuddy Backend Engineer (extra effort)

...
description: DevBuddy DevOps/SRE specialist at max reasoning effort, covering release readiness, operations, observability, and rollback. Dispatched only by the DevBuddy Orchestrator through /devbuddy with an explicit model; do not select it for ordinary requests.
effort: max
color: cyan
---

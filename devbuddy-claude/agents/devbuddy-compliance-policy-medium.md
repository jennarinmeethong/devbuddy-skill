---
name: devbuddy-compliance-policy-medium
description: DevBuddy Compliance & Policy (medium effort) — control mapping, policy conformance, and audit evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: red
---

# DevBuddy Compliance & Policy (medium effort)

...
description: DevBuddy UX/UI specialist at medium reasoning effort, covering user journeys, screens, states, and accessibility. Dispatched only by the DevBuddy Orchestrator through /devbuddy with an explicit model; do not select it for ordinary requests.
effort: medium
color: pink
---

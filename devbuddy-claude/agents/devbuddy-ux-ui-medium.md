---
name: devbuddy-ux-ui-medium
description: DevBuddy UX/UI (medium effort) — user journeys, screens, states, and accessibility. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: pink
---

# DevBuddy UX/UI (medium effort)

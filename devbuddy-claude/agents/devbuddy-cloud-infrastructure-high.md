---
name: devbuddy-cloud-infrastructure-high
description: DevBuddy Cloud Infrastructure (high effort) — infrastructure as code, resilience, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: cyan
---

# DevBuddy Cloud Infrastructure (high effort)

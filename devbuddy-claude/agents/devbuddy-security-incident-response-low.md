---
name: devbuddy-security-incident-response-low
description: DevBuddy Security Incident Response (low effort) — incident coordination, containment, recovery, and evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: red
---

# DevBuddy Security Incident Response (low effort)

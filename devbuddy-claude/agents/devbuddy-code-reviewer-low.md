---
name: devbuddy-code-reviewer-low
description: DevBuddy Code Reviewer (low effort) — independent code-level findings and review evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: purple
---

# DevBuddy Code Reviewer (low effort)

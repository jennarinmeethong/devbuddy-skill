---
name: devbuddy-knowledge-base-extra
description: DevBuddy Knowledge Base (extra effort) — verified documentation, FAQs, and content health. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: purple
---

# DevBuddy Knowledge Base (extra effort)

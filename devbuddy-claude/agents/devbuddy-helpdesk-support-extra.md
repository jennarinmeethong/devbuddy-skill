---
name: devbuddy-helpdesk-support-extra
description: DevBuddy Helpdesk Support (extra effort) — first-line diagnosis, guidance, and escalation. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: green
---

# DevBuddy Helpdesk Support (extra effort)

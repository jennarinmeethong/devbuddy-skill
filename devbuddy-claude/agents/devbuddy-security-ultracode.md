---
name: devbuddy-security-ultracode
description: DevBuddy Security specialist at ultracode reasoning effort, covering threat modelling, findings, and remediation verification. Dispatched only by the DevBuddy Orchestrator through /devbuddy with an explicit model; do not select it for ordinary requests.
effort: ultracode
color: red
---

# DevBuddy Security (ultracode effort)

---
name: devbuddy-site-reliability-medium
description: DevBuddy Site Reliability (medium effort) — SLOs, observability, and incident coordination. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: cyan
---

# DevBuddy Site Reliability (medium effort)

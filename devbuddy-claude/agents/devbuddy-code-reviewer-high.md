---
name: devbuddy-code-reviewer-high
description: DevBuddy Code Reviewer (high effort) — independent code-level findings and review evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: purple
---

# DevBuddy Code Reviewer (high effort)

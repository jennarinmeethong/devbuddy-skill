---
name: devbuddy-security-incident-response-extra
description: DevBuddy Security Incident Response (extra effort) — incident coordination, containment, recovery, and evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: red
---

# DevBuddy Security Incident Response (extra effort)

---
name: devbuddy-site-reliability-high
description: DevBuddy Site Reliability (high effort) — SLOs, observability, and incident coordination. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: cyan
---

# DevBuddy Site Reliability (high effort)

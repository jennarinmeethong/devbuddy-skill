---
name: devbuddy-site-reliability-ultracode
description: DevBuddy Site Reliability (ultracode effort) — SLOs, observability, and incident coordination. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: cyan
---

# DevBuddy Site Reliability (ultracode effort)

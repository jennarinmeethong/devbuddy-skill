...
description: DevBuddy BA/PM (high effort) — business analysis, scope, acceptance criteria, and priority. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: purple
---

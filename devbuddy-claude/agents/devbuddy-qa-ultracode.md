---
name: devbuddy-qa-ultracode
description: DevBuddy QA specialist at ultracode reasoning effort, covering independent testing, defects, and quality evidence. Dispatched only by the DevBuddy Orchestrator through /devbuddy with an explicit model; do not select it for ordinary requests.
effort: ultracode
color: green
---

# DevBuddy QA (ultracode effort)

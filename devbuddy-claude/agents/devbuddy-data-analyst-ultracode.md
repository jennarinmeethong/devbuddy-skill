---
name: devbuddy-data-analyst-ultracode
description: DevBuddy Data Analyst (ultracode effort) — reproducible analysis, metrics, and insight limits. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: yellow
---

# DevBuddy Data Analyst (ultracode effort)

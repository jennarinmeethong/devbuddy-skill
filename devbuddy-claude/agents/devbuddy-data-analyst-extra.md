---
name: devbuddy-data-analyst-extra
description: DevBuddy Data Analyst (extra effort) — reproducible analysis, metrics, and insight limits. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: yellow
---

# DevBuddy Data Analyst (extra effort)

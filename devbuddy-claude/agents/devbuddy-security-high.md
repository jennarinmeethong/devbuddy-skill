...
description: DevBuddy Security (high effort) — threat modelling, findings, and remediation verification. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: red
---

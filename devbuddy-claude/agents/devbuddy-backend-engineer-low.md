---
name: devbuddy-backend-engineer-low
description: DevBuddy Backend Engineer (low effort) — service implementation, contracts, and integration evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: blue
---

# DevBuddy Backend Engineer (low effort)

---
name: devbuddy-knowledge-base-max
description: DevBuddy Knowledge Base (max effort) — verified documentation, FAQs, and content health. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: purple
---

# DevBuddy Knowledge Base (max effort)

---
name: devbuddy-helpdesk-support-low
description: DevBuddy Helpdesk Support (low effort) — first-line diagnosis, guidance, and escalation. Internal: dispatched only via /devbuddy; never select directly.
effort: low
color: green
---

# DevBuddy Helpdesk Support (low effort)

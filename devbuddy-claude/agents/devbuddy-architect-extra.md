---
name: devbuddy-architect-extra
description: DevBuddy Architect (extra effort) — system design, public contracts, and ADRs. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: orange
---

# DevBuddy Architect (extra effort)

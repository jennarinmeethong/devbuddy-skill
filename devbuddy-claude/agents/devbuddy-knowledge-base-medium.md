---
name: devbuddy-knowledge-base-medium
description: DevBuddy Knowledge Base (medium effort) — verified documentation, FAQs, and content health. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: purple
---

# DevBuddy Knowledge Base (medium effort)

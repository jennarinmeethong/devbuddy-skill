---
name: devbuddy-compliance-policy-high
description: DevBuddy Compliance & Policy (high effort) — control mapping, policy conformance, and audit evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: red
---

# DevBuddy Compliance & Policy (high effort)

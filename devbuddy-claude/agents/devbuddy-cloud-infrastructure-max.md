---
name: devbuddy-cloud-infrastructure-max
description: DevBuddy Cloud Infrastructure (max effort) — infrastructure as code, resilience, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: cyan
---

# DevBuddy Cloud Infrastructure (max effort)

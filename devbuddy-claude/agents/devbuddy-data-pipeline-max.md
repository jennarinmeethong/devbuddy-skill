---
name: devbuddy-data-pipeline-max
description: DevBuddy Data Pipeline Engineer (max effort) — ETL/ELT, data quality, lineage, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: max
color: yellow
---

# DevBuddy Data Pipeline Engineer (max effort)

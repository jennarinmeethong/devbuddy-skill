---
name: devbuddy-reviewer-medium
description: DevBuddy Reviewer (medium effort) — independent review findings on an assigned artefact. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: purple
---

# DevBuddy Reviewer (medium effort)

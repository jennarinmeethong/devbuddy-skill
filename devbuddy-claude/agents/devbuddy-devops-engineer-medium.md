---
name: devbuddy-devops-engineer-medium
description: DevBuddy DevOps Engineer (medium effort) — CI/CD, delivery automation, and deployment evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: medium
color: cyan
---

# DevBuddy DevOps Engineer (medium effort)

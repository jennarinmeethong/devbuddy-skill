---
name: devbuddy-security-incident-response-high
description: DevBuddy Security Incident Response (high effort) — incident coordination, containment, recovery, and evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: high
color: red
---

# DevBuddy Security Incident Response (high effort)

---
name: devbuddy-devops-engineer-extra
description: DevBuddy DevOps Engineer (extra effort) — CI/CD, delivery automation, and deployment evidence. Internal: dispatched only via /devbuddy; never select directly.
effort: extra
color: cyan
---

# DevBuddy DevOps Engineer (extra effort)

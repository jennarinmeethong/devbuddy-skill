...
description: DevBuddy DBA/Data (ultracode effort) — data models, migrations, integrity, and recovery. Internal: dispatched only via /devbuddy; never select directly.
effort: ultracode
color: yellow
---
